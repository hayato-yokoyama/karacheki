...
- [x] スケールを変えずに、グラフを横スライドして表示期間を変える

### BIG3画面

- [x] ベンチプレス / スクワット / デッドリフトの挙上重量とレップ数を記録する
- [x] 挙上記録から推定1RMを換算する
- [x] 実際に1レップで挙げた自己ベストと、換算した自己ベストを分けて表示する
- [x] 記録を編集・削除できる
...
- [x] 保存した画像を撮影日順に一覧できる
- [x] 保存した画像を削除できる
- [x] Before/After画像を撮影してトリミングできる
- [x] セルフタイマー（3秒 / 10秒）付きのカメラで撮影できる
- [ ] 画像を端末に書き出す
- [x] 2枚を選択して、Before/Afterを比較できるようにする
- [x] 画像と測定データを紐づけて、比較できる
